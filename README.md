...
The contents of the folder `/api/browser` were generated by running `docfx metadata` against the core Steeltoe codebase. To generate/test this locally, run the following command: 
