...
|`AlwaysSample`|Whether to enable the OpenTelemetry `AlwaysOnSampler`|OpenCensus `Sampler`|
|`NeverSample`|Whether to enable the OpenTelemetry `AlwaysOffSampler`|OpenCensus `Sampler`|
