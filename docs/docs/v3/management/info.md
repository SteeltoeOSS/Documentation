...
For an example of how to use the above `GitInfoContributor` within MSBuild using [GitInfo](https://github.com/devlooped/GitInfo), see the [Steeltoe management sample](https://github.com/SteeltoeOSS/Samples/tree/3.x/Management/src/CloudFoundry) and the [CloudFoundry.csproj](https://github.com/SteeltoeOSS/Samples/blob/3.x/Management/src/CloudFoundry/CloudFoundry.csproj) file.
