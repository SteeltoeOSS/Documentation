...
Steeltoe Tooling is a [DotNet Global Tools](https://learn.microsoft.com/dotnet/core/tools/global-tools) console executable named `st`.  Use `dotnet tool install` to install.
