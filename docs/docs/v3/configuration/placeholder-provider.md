...
Alternatively, instead of accessing the configuration data directly from the configuration, you can also use the .NET [Options](https://learn.microsoft.com/aspnet/core/fundamentals/configuration) framework together with placeholders.
