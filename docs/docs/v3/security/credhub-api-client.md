...
CredHub supports permissions management on credential access for UAA users. See the [official CredHub permissions documentation](https://docs.cloudfoundry.org/api/credhub/version/main/#_permissions).
