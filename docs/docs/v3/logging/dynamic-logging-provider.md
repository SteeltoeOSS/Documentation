...
Before starting to use Steeltoe provider, you should know how the .NET [logging service](https://learn.microsoft.com/aspnet/core/fundamentals/logging/) works, as it is nothing more than a wrapper around the existing Microsoft console logger.
