...
In the [first tutorial](~/guides/messaging/tutorials/tutorial1/Readme.html) we
...
Please use the same VS2022 setup you used in [first tutorial](~/guides/messaging/tutorials/tutorial1/Readme.html). 
...
Now we can move on to [tutorial 3](~/guides/messaging/tutorials/tutorial3/Readme.html) and learn how to deliver the same message to many consumers.
