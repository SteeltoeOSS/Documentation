...
The directories below this one are used with DocFX to generate static HTML files that are served from `wwwroot`.
...
| `/steeltoe-template` | Customized copy of the modern DocFX template |
