...
The Steeltoe random value generator is a configuration provider that you can use to do just that. It can produce integers, longs, uuids, or strings, as the following examples show:
...
In order to use the Steeltoe random value provider, you need to:
