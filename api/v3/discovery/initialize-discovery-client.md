...
These new extensions provide a convenient way to register and activate the discovery client.  Alternatively, you can register and activate the client in the `ConfigureServices()` and `Configure()` methods of the `Startup` class:
