...
This package is an extension of the Microsoft OWIN JWT bearer token middleware. You should take some time to understand both the JWT and the OWIN middleware packages before proceeding to use this provider.
...
As mentioned earlier, there are two auth services (UAA Server and Pivotal SSO) on Cloud Foundry. Rather than explaining how to create and bind those services to your application here, we recommend that you read the documentation provided by each of the service providers.
